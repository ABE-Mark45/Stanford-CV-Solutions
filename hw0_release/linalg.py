...
def complicated_matrix_function(M, a, b):
    ...
    out = None
    ### YOUR CODE HERE
    out = dot_product(a, b) * np.dot(M, a.T)
    ### END YOUR CODE
...
def get_singular_values(M, k):
    ...
    singular_values = singular_values[np.argsort(-singular_values)[:k]]
    ### END YOUR CODE
...
def get_eigen_values_and_vectors(M, k):
    ...
    ### YOUR CODE HERE
    w, v = eigen_decomp(M)
    my_args = np.argsort(-w)[:k]
    eigenvalues = w[my_args]
    eigenvectors = v[my_args]
    ### END YOUR CODE
